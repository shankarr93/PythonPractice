...
#Importing datasets
train_df = pd.read_json('https://raw.githubusercontent.com/shankarr93/PythonPractice/master/Analytics/Prediction/train.json')
test_df = pd.read_json('https://raw.githubusercontent.com/shankarr93/PythonPractice/master/Analytics/Prediction/test.json')
...
print('Please find Cuisine Prediction results for the test dataset below:')
